...
public class ItemGuideBook extends ItemEditableBook {
  ...
  public static NBTTagCompound generateBookContents() {
    ...
    pages.appendTag(new NBTTagString("4", "推荐同时转载EMI模组以获取本模组新增物品/方块的配方信息"));
    pages.appendTag(new NBTTagString("5", "*有关水分 7-12页\n*有关熔炉 13页\n*有关矿物规划 14-15页\n*有关金苹果 16页\n*有关新金属 17-19页"));
    pages.appendTag(new NBTTagString("6", "*有关新生物群系 20-21页\n*有关额外机制 22-26页\n*有关新物品 29-35页\n*附页 36页+"));
    pages.appendTag(new NBTTagString("7", "在游玩模组时，作者默认「玩家」(下称「你」)已经游玩过MITE原版并拥有一定的理论知识，同时一部分已有的无关痛痒的机制碍于篇幅不再赘述。"));
    pages.appendTag(new NBTTagString("8", "位于玩家状态栏右下角饱食度上方的即模组新添加的水分条，依然会随时间推移减少，在玩家食用特定食物时将直接减少或者增加。"));
    pages.appendTag(new NBTTagString("9", "在食用肉类时这个条会立即减少，在它为空时玩家将逐渐减少血量直到死亡；留意一些新的花和仙人掌，在合成后将触发一个新的成就：紧急避险。对应的合成产物可以在你做出碗之前恢复水分值。"));
    pages.appendTag(new NBTTagString("10", "如果对水分拥有迫切的需求，你可以在水中按住潜行键并保持一段时间，这也会让你恢复一部分水分。\n\n至此，你可以正常前进到燧石工具时代了。"));
    pages.appendTag(new NBTTagString("11", "在做出碗舀取水分乃至你在水中潜行获得debuff时，你可能会留意到多数地区的水饮用之后会出现问题，你可以使用黏土炉去蒸馏「一碗可疑的水」或者「一碗沼泽水」来让水变得安全(务必参考p33)。"));
    ...
    pages.appendTag(new NBTTagString("14", "在玩家做出第一把铜镐挖掘矿物时，你可能会惊讶于矿物的掉落，保持淡定。按照MITE原版的第一把镐的规划先石头再煤炭最后铜矿即可，在熔炉中将之冶炼成金属粒并合成，保持你的耐心。"));
    pages.appendTag(new NBTTagString("15", "一块煤炭可以烧炼32个矿物碎块，不必担心你需要挖大量的煤矿用于冶炼矿物；\n此外，在没有足够耐高温的金属桶前使用岩浆烧炼矿物时极其冒险的行为。"));
    pages.appendTag(new NBTTagString("16", "金苹果在MITE-ITF的强度被大幅度削弱，基本没有办法在强大怪物面前救你一命，它在MIT-ITF的定位更类似于酿造材料，请参考MITE-ITF合成表内的实验药水，亦或是将它丢进酿造台。"));
    ...
    pages.appendTag(new NBTTagString("26", "* 宝石机制 *\n请使用钻石，古代金属，黑曜石制作「附魔回流底座」来提取宝石的经验，GUI上侧可放入宝石转化经验，并在下方用水瓶或金属粒提取。"));
    pages.appendTag(new NBTTagString("27", "* 附魔强化 *\n使用秘银，附魔之瓶，黑曜石制作的「附魔增幅底座」可以放置在附魔台下方用于强化附魔台来获取更强大的附魔效能和更高昂的经验费用。在乌鲁金属上尤为有益。"));
    pages.appendTag(new NBTTagString("28", "* 附魔预测 *\n使用秘银，附魔之瓶，黑曜石，锻造笔记制作的「附魔占卜底座」可以放置在附魔台下方用于强化附魔台来预知这次附魔包含的其中一个属性。"));
    pages.appendTag(new NBTTagString("29", "* 超级附魔工具 *\n使用秘银，锻造笔记，钻石附魔台，附魔增幅底座，附魔占卜底座，末影之眼制作的「魔法附魔台」可以同时拥有附魔回流底座与附魔占比底座的能力"));
    pages.appendTag(new NBTTagString("30", "* 高版本移植 *\n添加了一些自高版本中移植的怪物，物品并予以MITE拓展(包括MITE本体拓展出的怪物)，这些新添加的物品将不再于之后的文本中赘述。"));
    pages.appendTag(new NBTTagString("31", "* 法杖 *\n自遗迹宝箱和部分骷髅手中获得的远程武器，拥有平直弹道并可以对怪物施加一些特殊的debuff。"));
    pages.appendTag(new NBTTagString("32", "* 钉锤 *\n对护甲和骷髅强化的武器，在攻击目标时额外无视目标3点护甲且对骷髅拥有100%的增伤，类似战锤"));
    pages.appendTag(new NBTTagString("33", "* 陶瓦碗 *\n单个黏土可以合成黏土碗并在熔炉中4个为一个单位烧制成陶瓦碗，拥有碗类相同的功效并可以烧水；\n\n注意：木碗无法烧水！"));
    pages.appendTag(new NBTTagString("34", "* 图腾 *\n移植自高版本的不死图腾，每种图腾都拥有不同的效果，但是需要手持才能生效(在受到死亡攻击时消失并产生效果)！"));
    pages.appendTag(new NBTTagString("35", "* 乌鲁金属信标 *\n更加强大的信标，无法使用金银铜激活，能够提供与常规信标不同的效果"));
    pages.appendTag(new NBTTagString("36", "* 配置文件 *\n详见「Configs/MITE-ITF-Reborn.json」，你也在ManyLib的配置界面快速修改配置，按照正常流程更改其中的配置可以让玩家体验到更加不一样的MITE-ITF。"));
    pages.appendTag(new NBTTagString("37", "更多改动详见更新日志！ 链接：https://docs.qq.com/doc/p/6556873ce3bc40e32e1b61a0d05e8dc461792230"));
    nbt.setString("flavor_text", "尝试在扭曲的MITE世界中活下去");
    return nbt;
  }
}
