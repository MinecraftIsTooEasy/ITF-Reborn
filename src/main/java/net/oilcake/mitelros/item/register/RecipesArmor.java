...
public class RecipesArmor extends Items {
    ...
    private static void registerFullMetalToolRecipe(CraftingRecipeRegisterEvent register, Material material) {
        ...
        if (FishModLoader.hasMod("mite_ite")) {
            RecipesArmor.registerITEArmorRecipe(register);
        } else {
            RecipesArmor.registerArmorRecipe(register, item_chain, material, false);
        }
        registerArmorRecipe(register, item_ingot, material, true);
    ...
    private static void registerITEArmorRecipe(CraftingRecipeRegisterEvent register) {
        ...
        register.registerShapedRecipe(new ItemStack(Item.plateIron), false, new Object[]{"XYX", "XXX", "XXX", Character.valueOf('X'), Item.ingotCopper, Character.valueOf('Y'), Item.helmetCopper});
        register.registerShapedRecipe(new ItemStack(Item.legsIron), false, new Object[]{"XXX", "XYX", "X X", Character.valueOf('X'), Item.ingotCopper, Character.valueOf('Y'), Item.helmetCopper});
        register.registerShapedRecipe(new ItemStack(Item.bootsIron), false, new Object[]{"XYX", "X X", Character.valueOf('X'), Item.ingotCopper, Character.valueOf('Y'), Item.helmetCopper});
        ...
        register.registerShapedRecipe(new ItemStack(Items.nickelChestplate), false, new Object[]{"XYX", "XXX", "XXX", Character.valueOf('X'), Items.nickelIngot, Character.valueOf('Y'), Item.helmetSilver});
        register.registerShapedRecipe(new ItemStack(Items.nickelLeggings), false, new Object[]{"XXX", "XYX", "X X", Character.valueOf('X'), Items.nickelIngot, Character.valueOf('Y'), Item.helmetSilver});
        register.registerShapedRecipe(new ItemStack(Items.nickelBoots), false, new Object[]{"XYX", "X X", Character.valueOf('X'), Items.nickelIngot, Character.valueOf('Y'), Item.helmetSilver});
        ...
        register.registerShapedRecipe(new ItemStack(Item.plateChainAncientMetal), false, new Object[]{"XYX", "XXX", "XXX", Character.valueOf('X'), Item.ingotAncientMetal, Character.valueOf('Y'), Items.nickelHelmet});
        register.registerShapedRecipe(new ItemStack(Item.legsAncientMetal), false, new Object[]{"XXX", "XYX", "X X", Character.valueOf('X'), Item.ingotAncientMetal, Character.valueOf('Y'), Items.nickelHelmet});
        register.registerShapedRecipe(new ItemStack(Item.bootsAncientMetal), false, new Object[]{"XYX", "X X", Character.valueOf('X'), Item.ingotAncientMetal, Character.valueOf('Y'), Items.nickelHelmet});
        ...
        register.registerShapedRecipe(new ItemStack(Items.tungstenChestplate), false, new Object[]{"XYX", "XXX", "XXX", Character.valueOf('X'), Items.tungstenIngot, Character.valueOf('Y'), Item.helmetAncientMetal});
        register.registerShapedRecipe(new ItemStack(Items.tungstenLeggings), false, new Object[]{"XXX", "XYX", "X X", Character.valueOf('X'), Items.tungstenIngot, Character.valueOf('Y'), Item.helmetAncientMetal});
        register.registerShapedRecipe(new ItemStack(Items.tungstenBoots), false, new Object[]{"XYX", "X X", Character.valueOf('X'), Items.tungstenIngot, Character.valueOf('Y'), Item.helmetAncientMetal});
        ...
        register.registerShapedRecipe(new ItemStack(Item.plateChainAdamantium), false, new Object[]{"X X", "XYX", "XXX", Character.valueOf('X'), Item.ingotAdamantium, Character.valueOf('Y'), Items.tungstenHelmet});
        register.registerShapedRecipe(new ItemStack(Item.legsAdamantium), false, new Object[]{"XYX", "X X", "X X", Character.valueOf('X'), Item.ingotAdamantium, Character.valueOf('Y'), Items.tungstenHelmet});
        register.registerShapedRecipe(new ItemStack(Item.bootsAdamantium), false, new Object[]{"X Y", "X X", Character.valueOf('X'), Item.ingotAdamantium, Character.valueOf('Y'), Items.tungstenHelmet});
    }
